...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        KC_PWR , KC_SLEP, KC_WAKE, KC_NO  , KC_CPNL, KC_MYCM, KC_CALC, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_KB_POWER, KC_MUTE, KC_VOLD, KC_VOLU,
        RGB_TOG, RGB_SAI, RGB_HUI, RGB_VAI, RGB_SPI, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,     KC_NO  , KC_NO  , KC_NO  ,
        KC_NO  , KC_NO  , KC_UP  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,     KC_NO  , KC_NO  , KC_NO  ,
        KC_SCRL, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,
        KC_LSFT, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,          KC_RSFT,              RGB_VAI,
        KC_NO  , KC_NO  , KC_NO  ,                            KC_NO  ,                            KC_NO  , KC_NO  , KC_TRNS,    RGB_RMOD, RGB_VAD, RGB_MOD
    )
};
